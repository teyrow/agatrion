...
- `verktyg/bygg-prov-anfang.py` bygger `docs/prov/anfang.html`, där anfangen visas i sex
  storlekar i två spaltbredder. Storleken som gäller sätts av `--anfang` i `style.css` —
  titta på provsidan först, ändra variabeln sedan. Sidan läser texterna ur `index.html` och
  är därför alltid i fas.
