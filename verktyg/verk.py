...
VERK = {
    ...
    # Etikettfilerna sa "Andante ur pianotrio nr 1", men Andreas har r\u00e4ttat: trion har
    # bara spelat a-mollstrion. Alla fem inspelningarna \u00e4r dess Lento.
    "chaminade-op34": dict(
        tonsattare="C\u00e9cile Chaminade", titel="Pianotrio nr 2 i a-moll, op. 34",
        satser=["Allegro moderato", "Lento", "Allegro energico"]),
    "haydn-c": dict(
...
SPAR = {
    ...
    "brannestad-2024/09-cecile-chaminade-andante-ur-pianotrio-nr-1.mp3": ("chaminade-op34", 2, "belagd"),
    ...
    "ekeby-2023/07-chaminade.mp3":                                    ("chaminade-op34", 2, "belagd"),
    ...
    "tranas-2024/06-cecile-chaminade-andante-ur-pianotrio-nr-1.mp3":  ("chaminade-op34", 2, "belagd"),
    ...
    "tranas-2026/07-cecile-chaminade-andante-ur-pianotrio-nr-1.mp3":  ("chaminade-op34", 2, "belagd"),
    ...
    "vastra-ryd-2021/04-cecile-chaminade-ur-pianotrion.mp3":          ("chaminade-op34", 2, "analys"),
